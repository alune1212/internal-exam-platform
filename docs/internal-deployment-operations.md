...
- 正式应考人员入口地址固定为 192.168.2.34/24，必须 DHCP reservation。pf/受管防火墙仅允许 192.168.2.0/24 到 192.168.2.34:8080；operator 8081 严格仅 127.0.0.1。HTTP 是明确接受的第一阶段安全例外，不是传输安全。
