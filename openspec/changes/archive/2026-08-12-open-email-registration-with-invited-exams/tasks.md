...
- [x] 12.5 Execute controlled real-SMTP UAT for one OTP registration/login and one initial-plus-failed-resend invitation flow, confirming bounded retries, correct links, redacted logs, and no automatic publication mail.
